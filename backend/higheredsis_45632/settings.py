"""
Django settings for higheredsis_45632 project.
...
ROOT_URLCONF = 'higheredsis_45632.urls'
...
WSGI_APPLICATION = 'higheredsis_45632.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "higheredsis_45632 API",
    "DESCRIPTION": "API documentation for higheredsis_45632 App",
    "VERSION": "v1",
}
